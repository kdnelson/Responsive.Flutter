...
import 'package:responsive_flutter/widgets/home/mobile/landscape/mobile_home_landscape_comments_per_post_widget.dart';

class MobileHomeLandscapePostDetailsWidget extends StatelessWidget {
  final HomeViewModel model;
  final int postIndex;
  MobileHomeLandscapePostDetailsWidget(this.model, this.postIndex);
                ...
                body: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 20),
                      MobileHomeLandscapeCommentsPerPostWidget()
                    ],
                  ),
                ),
              ));
