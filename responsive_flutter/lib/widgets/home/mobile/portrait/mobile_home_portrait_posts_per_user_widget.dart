...
import 'package:responsive_flutter/widgets/home/mobile/portrait/mobile_home_portrait_post_details_widget.dart';
import 'package:responsive_flutter/widgets/home/common/mobile_home_posts_listview_widget.dart';

class MobileHomePortraitPostsPerUserWidget
        ...
        itemBuilder: (context, index) => MobileHomePostsListViewWidget(
              ...
              onTap: () {
                locator<NavigatorService>().navigateToPage(MaterialPageRoute(
                    builder: (context) =>
                        MobileHomePortraitPostDetailsWidget(model, index)));
              },
            ));
  }
}
